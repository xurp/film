package com.geekq.guns.modular.code.factory;


import com.geekq.guns.GunsAdminApplication;
import com.geekq.guns.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("geekq");
        genQo.setProjectPackage(GunsAdminApplication.class.getPackage().getName());
