package com.geekq.guns.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://39.107.245.253:3306/guns?characterEncoding=utf8");
    }
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.geekq.guns.admin.common.persistence.model");
        packageConfig.setMapper("com.geekq.guns.admin.common.persistence.dao");
        packageConfig.setXml("com.geekq.guns.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.geekq.guns.admin");
        contextConfig.setCoreBasePackage("com.geekq.guns.core");
